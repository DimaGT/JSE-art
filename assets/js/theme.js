...
(function ($) {
   ...
   // ============================================================================
	...
	if ($(".portfolio-split").length) {
		...
		// Initialize video pause on page load
		// ===================================
	...
	.not('[href^="tel"]') // omit from selection
	.on('click', function() {
		$("body").removeClass("tt-demo-btn-active");
		gsap.to(".tt-demo-btn", { duration: 0.3, scale: 0.9, autoAlpha: 0 });
	});
...
$("#pspl-list, #footer-social, #footer-email").css({
    "opacity": "0",
    "display": "none"
});

$("#menu-toggle-btn-wrap, #menu-toggle-btn-holder").css({
    "opacity": "0"
}); 
...
$(document).ready(function() {
    ...
    var timeout = setTimeout(function() {
        $("#menu-toggle-btn-wrap, #menu-toggle-btn-holder").animate({
            opacity: 1
        }, 500);

        $("#pspl-list, #footer-social, #footer-email")
            .css("display", "block")
            .animate({
                opacity: 1
            }, 500);
    ...
    // Show elements immediately on click
